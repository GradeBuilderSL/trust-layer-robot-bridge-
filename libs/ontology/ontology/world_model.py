...
# Object3D — 3D spatial object representation needed by some services
from dataclasses import dataclass as _dc3d, field as _f3d
from typing import Optional as _Opt3d, List as _L3d

@_dc3d
class Object3D:
    """3D world object representation."""
    object_id: str = ""
    entity_id: str = ""     # alias for object_id used in some PRs
    label: str = ""
    x: float = 0.0
    y: float = 0.0
    z: float = 0.0
    ...
    class_name: str = ""
    category: str = ""
    metadata: dict = _f3d(default_factory=dict)
